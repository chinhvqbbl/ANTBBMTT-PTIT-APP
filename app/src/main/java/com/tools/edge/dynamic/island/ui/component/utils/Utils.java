package com.tools.edge.dynamic.island.ui.component.utils;
...
import com.tools.edge.dynamic.island.ui.component.Controllers.AirPlaneModeController;
import com.tools.edge.dynamic.island.ui.component.Controllers.AlarmsController;
import com.tools.edge.dynamic.island.ui.component.Controllers.AudioSettingController;
import com.tools.edge.dynamic.island.ui.component.Controllers.BatterySaverController;
import com.tools.edge.dynamic.island.ui.component.Controllers.BlueToothSettingController;
import com.tools.edge.dynamic.island.ui.component.Controllers.BrightnessModeController;
import com.tools.edge.dynamic.island.ui.component.Controllers.DarkModeController;
import com.tools.edge.dynamic.island.ui.component.Controllers.DataSyncController;
import com.tools.edge.dynamic.island.ui.component.Controllers.DataUsageController;
import com.tools.edge.dynamic.island.ui.component.Controllers.DisplaySettingIntent;
import com.tools.edge.dynamic.island.ui.component.Controllers.ExpandNotificationPanel;
import com.tools.edge.dynamic.island.ui.component.Controllers.HotSpotController;
import com.tools.edge.dynamic.island.ui.component.Controllers.KeyBoardController;
import com.tools.edge.dynamic.island.ui.component.Controllers.LocationSettingController;
import com.tools.edge.dynamic.island.ui.component.Controllers.LockScreenController;
import com.tools.edge.dynamic.island.ui.component.Controllers.MobileDataController;
import com.tools.edge.dynamic.island.ui.component.Controllers.NFCController;
import com.tools.edge.dynamic.island.ui.component.Controllers.NightModeController;
import com.tools.edge.dynamic.island.ui.component.Controllers.ScreenCastController;
import com.tools.edge.dynamic.island.ui.component.Controllers.ScreenRecordController;
import com.tools.edge.dynamic.island.ui.component.Controllers.ScreenShotController;
import com.tools.edge.dynamic.island.ui.component.Controllers.ScreenTimeController;
import com.tools.edge.dynamic.island.ui.component.Controllers.ScreenTimoutController;
import com.tools.edge.dynamic.island.ui.component.Controllers.SimSelectController;
import com.tools.edge.dynamic.island.ui.component.Controllers.StillCameraController;
import com.tools.edge.dynamic.island.ui.component.Controllers.TorchMainController;
import com.tools.edge.dynamic.island.ui.component.Controllers.WifiController;
import com.tools.edge.dynamic.island.ui.component.Controllers.ZenModeController;
...
public class Utils {
    ...
    public void startAppNotificationSetting(Context context2) {
        ...
        try {
            ...
            Toast.makeText(context2, "Setting not found!", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public ArrayList<ButtonState> getButtonsList() {
        ...
        while (it.hasNext()) {
            ButtonState buttonSate = null;
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP_MR1) {
                buttonSate = getButtonSate((String) it.next());
            }
            if (buttonSate != null) {
    ...
    public ButtonState getButtonSate(String str) {
        ...
        switch (c) {
            ...
            case 13:
                try {
                    SubscriptionManager subscriptionManager = (SubscriptionManager) this.context.getSystemService(Context.TELEPHONY_SUBSCRIPTION_SERVICE);
    ...
    private static final String TAG = "chin_chin_battery";

    public int getAirpodsBattery() {
        int airPodLevel = getAirPodLevel();
        Log.d(TAG, "airPodLevel: " + getAirPodLevel());
        if (airPodLevel == -1) {
            return -1;
        }
        ...
        Log.d(TAG, "getAirpodsBattery: " + i2);
        return i == 10 ? R.drawable.airbug_10 : i2;
//        return R.drawable.airbug_10;
    }
        ...
        try {
            ...
            for (BluetoothDevice address : BluetoothAdapter.getDefaultAdapter().getBondedDevices()) {
                try {
                    ...
                    int percent = ((Integer) remoteDevice.getClass().getMethod("getBatteryLevel", new Class[0]).invoke(remoteDevice, new Object[0])).intValue();
                    if (percent != -1) {
                        Log.d(TAG, "getAirPodLevel: " + percent);
                        return percent;
                    }
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public int getBatteryLevel() {
        return ((BatteryManager) this.context.getSystemService(Context.BATTERY_SERVICE)).getIntProperty(4);
    }
    ...
    public boolean isSimPresent() {
        return ((TelephonyManager) this.context.getSystemService(Context.TELEPHONY_SERVICE)).getSimState() == TelephonyManager.SIM_STATE_READY;
    }
    ...
    public void setMobileDataState(boolean z, Context context2) {
        try {
            TelephonyManager telephonyManager = (TelephonyManager) context2.getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public void gpsstate(Context context2, LottieAnimationView lottieAnimationView) {
        if (((LocationManager) context2.getSystemService(Context.LOCATION_SERVICE)).isProviderEnabled("gps")) {
            setLottiViewState(lottieAnimationView, "start", "mid", true);
    ...
    public void startForegroundService(Context context2) {
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (notificationManager.getNotificationChannel("FOREGROUND_INFO") == null) {
                NotificationChannel notificationChannel = new NotificationChannel("FOREGROUND_INFO", "Keep Alive", NotificationManager.IMPORTANCE_LOW);
            ...
            builder.setColor(context2.getResources().getColor(R.color.app_txt_colr));
        ...
        if (activityManager != null) {
            for (ActivityManager.RunningServiceInfo serviceInfo : activityManager.getRunningServices(Integer.MAX_VALUE)) {
                if (serviceName.equals(serviceInfo.service.getClassName())) {
                    // Tìm thấy dịch vụ trong danh sách các dịch vụ đang chạy
                    return true;
                }
            }
        }

        // Không tìm thấy dịch vụ trong danh sách các dịch vụ đang chạy
        return false;
    }
