...
public class Constants {
    ...
    public static final String KEY_SHOW_MUSIC = "key_show_music" ;
    public static final String KEY_SHOW_MUSIC_ROATE ="key_show_music_rotate" ;
    public static final String UPDATE_MODUL = ".update.moduls";
    public static final String KEY_SHOW_BATTERYCHANGE = "key_show_battery_change" ;
    public static final String KEY_SHOW_RINGTONE_MODE = "key_show_ringtone_mode" ;
    public static final String KEY_SHOW_NAVIGATION = "key_show_navigation" ;
    public static final String LIST_PACKAGE_DISABLE = "list_package_disable";
    ...
    public static final String KEY_MODULES = "key_modules";
    ...
    public static boolean checkAccessibilityEnabled(Context context) {
        ...
        while (simpleStringSplitter.hasNext()) {
            if (simpleStringSplitter.next().equalsIgnoreCase(context.getPackageName() + "/" + ITGAccessibilityService.class.getName())) {
                return true;
            }
        }
        return false;
