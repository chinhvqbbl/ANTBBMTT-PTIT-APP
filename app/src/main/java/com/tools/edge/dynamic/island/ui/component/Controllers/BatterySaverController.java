...
public class BatterySaverController extends ButtonState {
    ...
    public boolean setMode() {
        if (this.context.getPackageManager().checkPermission("android.permission.WRITE_SECURE_SETTINGS", this.context.getPackageName()) != PackageManager.PERMISSION_GRANTED) {
            Toast.makeText(this.context, "No permission to write settings", Toast.LENGTH_LONG).show();
            return false;
        }
        boolean z = !getState();
