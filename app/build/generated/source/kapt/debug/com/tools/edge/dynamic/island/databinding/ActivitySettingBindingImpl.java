...
public class ActivitySettingBindingImpl extends ActivitySettingBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.layout_tools_bar, 1);
        sViewsWithIds.put(R.id.imv_back, 2);
        sViewsWithIds.put(R.id.layout_rate, 3);
        sViewsWithIds.put(R.id.layout_share, 4);
        sViewsWithIds.put(R.id.layout_language, 5);
        sViewsWithIds.put(R.id.layout_more_app, 6);
    }
    // views
    // variables
    // values
